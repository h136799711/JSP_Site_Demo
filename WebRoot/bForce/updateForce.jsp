...
<em> <script src="js/validate.JS"></script>
	<html>
		<head>
				...
				<table width="800" height="465" border="1" cellpadding="0"
					...
					<tr>
						<td height="400" align="center" valign="top"
							...
							<br>
							<form action="UpdateForceServlet" method="post"
								onSubmit="return Mycheck()">
								<table width="415" border="1" cellpadding="0" cellspacing="0">
									<tr>
										<td>
											<input type="hidden" name="focusId" value="${news.focusId}" />
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											&nbsp;
											<textarea cols="42" rows="18" name="focusContent">${news.focusContent} </textarea>
										</td>
									</tr>
									<tr>
