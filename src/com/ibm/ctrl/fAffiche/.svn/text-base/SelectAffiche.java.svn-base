...
public class SelectAffiche extends BaseAfficheServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Notice> list = NewService().selectTop(5);
		...
		while (iter.hasNext()) {
			...
			tmp = "<a href='fAffiche/SelectAfficheContent?id="
					+ +notice.getNoId() + "' target='_parent'>"
					+ notice.getNoTitle() + "</a>";
			txtReply += tmp;
