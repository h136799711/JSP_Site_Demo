...
public class SelectForceDetailsServlet extends BaseForceServlet {
	 ...
	 */
	public SelectForceDetailsServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (news.getFocusId() == Integer.MIN_VALUE) {
			...
			request.getRequestDispatcher("selectForceContent.jsp").forward(
					request, response);
		}
	}
